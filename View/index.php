    ...
    <div class="wrapper">
                    ...
                    <li class="side-nav-item">
                        ...
                        <div class="collapse" id="sidebarProjects">
                            <ul class="side-nav-second-level">
                                <li>
                                    <a href="../modules/customer/customer.php">Customer</a>
                                </li>
                                <li>
        ...
        <div class="navbar-custom">
            <ul class="list-unstyled topbar-menu float-end mb-0">
                <li class="notification-list d-flex justify-content-center align-items-center mx-auto">
                    <img src="../assets/images/logo.jpg" alt="Logo" height="32" class="my-2">
                </li>
        ...
        <div class="content-page">
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <p>This is the main content area where you can display your data.</p>
                    <!-- Add your data or components here -->
                </div>
            </div>
        </div>
        <!-- Content End -->
